...
class Parser:
    ...
    def if_expr(self):
        ...
        if not self.current_tok.matches(TT_KEYWORD, 'BHIF'):
            return res.failure(InvalidSyntaxError(
                self.current_tok.pos_start, self.current_tok.pos_end,
                f"Expected 'BHIF'"
            ))
        ...
        while self.current_tok.matches(TT_KEYWORD, 'BHELIF'):
            res.register_advancement()
            self.advance()
    ...
    def for_expr(self):
        ...
        if not self.current_tok.matches(TT_KEYWORD, 'BHOR'):
            return res.failure(InvalidSyntaxError(
                self.current_tok.pos_start, self.current_tok.pos_end,
                f"Expected 'BHOR'"
            ))
    ...
    def atom(self):
        ...
        elif tok.matches(TT_KEYWORD, 'BHOR'):
    ...
    def comp_expr(self):
        ...
        if res.error:
            return res.failure(InvalidSyntaxError(
                self.current_tok.pos_start, self.current_tok.pos_end,
                "Expected int, float, identifier, '+', '-', '(' or 'BHOT'"
            ))
    ...
    def expr(self):
        ...
        if self.current_tok.matches(TT_KEYWORD, 'BHET'):
            res.register_advancement()
            self.advance()
        ...
        if res.error:
            return res.failure(InvalidSyntaxError(
                self.current_tok.pos_start, self.current_tok.pos_end,
                "Expected 'BHET', int, float, identifier, '+', '-', '(' or 'BHOT'"
            ))
...
global_symbol_table.set("BHULL", Number(0))
global_symbol_table.set("BHALSE", Number(0))
global_symbol_table.set("BHRUE", Number(1))
